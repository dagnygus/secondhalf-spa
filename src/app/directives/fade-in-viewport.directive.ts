...
import { OnInit, ElementRef, OnDestroy, AfterViewInit, OnChanges, SimpleChanges } from '@angular/core';
...
export class FadeInViewportDirective implements OnInit, OnDestroy, OnChanges {
  ...
  private _update(element: HTMLElement): void {
    const intersectionRatio = this._getIntersectionRation(element);
  ...
  private _getIntersectionRation(element: HTMLElement): number {
