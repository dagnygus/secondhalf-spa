import { fadeInAnimation, fadeInLeftAnimation, fadeInRightAnimation, fadeInDownAnimation } from './../../utils/ng-animations';
...
import { transition, trigger, useAnimation, animate, keyframes, style } from '@angular/animations';
