...
import { AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ElementRef, EventEmitter, Input, IterableChanges, IterableDiffer, IterableDiffers, OnInit, Output, Renderer2, RendererStyleFlags2, ViewChild } from '@angular/core';
import { Observable } from 'rxjs';
import { SingleMemberPhotosComponent, SingleMemberPhotosMediator } from '../single-member-photos.component';
...
export class SingleMemberPhotosDisplayerComponent extends Destroyable implements OnInit, AfterViewInit {
